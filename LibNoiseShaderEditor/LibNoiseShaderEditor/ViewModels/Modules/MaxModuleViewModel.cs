...
{
    public sealed class MaxModuleViewModel : ModuleNodeViewModel<MaxModuleSetting>
    {
        static MaxModuleViewModel()
        {
            Splat.Locator.CurrentMutable.Register(() => new MaxModuleNodeView(), typeof(IViewFor<MaxModuleViewModel>));
        }
        ...
        public MaxModuleViewModel(MainViewModel main)
            : base(main)
        {
            this.Name = "Max Module";
        ...
        private IModule BuildModule()
        {
            ...
            var module = new MaxModule(Input1.Value, Input2.Value)
            {
                Name = Setting.Name
            };
