...
{
    public sealed class AddModuleViewModel : ModuleNodeViewModel<AddModuleSetting>
    {
        static AddModuleViewModel()
        {
            Splat.Locator.CurrentMutable.Register(() => new AddModuleNodeView(), typeof(IViewFor<AddModuleViewModel>));
        }
        ...
        private IModule BuildModule()
        {
            ...
            var module = new AddModule(Input1.Value, Input2.Value)
            {
                Name = Setting.Name
            };
