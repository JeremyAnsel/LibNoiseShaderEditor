...
{
    public sealed class MultiplyModuleViewModel : ModuleNodeViewModel<MultiplyModuleSetting>
    {
        static MultiplyModuleViewModel()
        {
            Splat.Locator.CurrentMutable.Register(() => new MultiplyModuleNodeView(), typeof(IViewFor<MultiplyModuleViewModel>));
        }
        ...
        public MultiplyModuleViewModel(MainViewModel main)
            : base(main)
        {
            this.Name = "Multiply Module";
        ...
        private IModule BuildModule()
        {
            ...
            var module = new MultiplyModule(Input1.Value, Input2.Value)
            {
                Name = Setting.Name
            };
